...
panelfile, panelfilename, (panelsuffix, panelmode, paneltype) = imp.find_module("panel_types_two", path=[PWD])
...
from panel_types_two import PW_1, PW_1_L, PW_1_S, PW_2_L, PW_2_S, PC_W_1
